        ...
        >
          <div>
            ...
            <div className="space-y-3">
              <div className="flex gap-3">
                <div className="w-5 h-5 rounded-full bg-[var(--accent)]/20 flex items-center justify-center text-[10px] font-bold text-[var(--accent)] shrink-0">
                  1
                </div>
              ...
              <div className="flex gap-3">
                ...
                <p className="text-sm text-[var(--text-secondary)]">
                  Paste in terminal (
                  <code className="text-xs bg-[var(--bg-tertiary)] px-1 py-0.5 rounded">
                    Ctrl+Shift+V
                  </code>
                  ) and run
                </p>
          ...
          <div className="pt-3 border-t border-[var(--border-primary)]">
            ...
            <div className="space-y-2.5 text-xs text-[var(--text-muted)] leading-relaxed">
              <p>
                Greyed-out apps aren&apos;t in your distro&apos;s repos.
              ...
              <ul className="space-y-2 ml-2">
                <li className="flex gap-2">
                  ...
                  <span>
                    ...
                    Switch to Flatpak or Snap in the distro selector for
                    universal packages
                  </span>
                </li>
                <li className="flex gap-2">
                  ...
                  <span>
                    ...
                    Visit the app&apos;s official site and grab the{" "}
                ...
                <li className="flex gap-2">
                  ...
                  <span>
                    ...
                    Many apps publish packages on their GitHub releases page
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-[var(--accent)]">•</span>
                  <span>
                    ...
                    Some unavailable apps show links to alternative download
                    methods
                  </span>
                </li>
              </ul>
          ...
          <div className="pt-3 border-t border-[var(--border-primary)]">
            ...
            <p className="text-xs text-[var(--text-muted)] leading-relaxed">
              Some Arch packages are in the{" "}
              <strong className="text-[var(--text-secondary)]">AUR</strong>{" "}
              (Arch User Repository). TuxMate uses{" "}
              <code className="bg-[var(--bg-tertiary)] px-1 rounded">yay</code>{" "}
              to install these. If you don&apos;t have yay, check &quot;I have
              yay installed&quot; to skip auto-installation, or leave it
              unchecked to install yay first.
            </p>
          </div>
          ...
          <div className="pt-3 border-t border-[var(--border-primary)]">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="flex items-center gap-2">
                <kbd className="px-1.5 py-0.5 bg-[var(--bg-tertiary)] text-[var(--text-secondary)] rounded text-[10px] font-mono">
                  ↑↓
                </kbd>
            ...
            <ul className="space-y-2 text-xs text-[var(--text-muted)] leading-relaxed">
              <li className="flex gap-2">
                ...
                <span>
                  ...
                  gives you a full shell script with progress tracking, error
                  handling, and a summary
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-emerald-500">💡</span>
                <span>
                  ...
                  — come back anytime to modify your setup
                </span>
              </li>
              <li className="flex gap-2">
                <span className="text-emerald-500">💡</span>
