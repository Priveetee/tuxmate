      ...
      <>
        ...
        <div
          ...
          style={{
            ...
            minWidth: "200px",
            boxShadow:
              "0 20px 60px -10px rgba(0,0,0,0.2), 0 0 0 1px rgba(0,0,0,0.05)",
            transformOrigin: "top right",
            animation:
              "distroDropdownOpen 0.35s cubic-bezier(0.34, 1.56, 0.64, 1)",
          }}
        >
          ...
          <div className="space-y-0.5">
            {distros.map((distro, i) => (
              <button
                ...
                className={`group w-full flex items-center gap-3 py-2.5 px-3 rounded-xl border-none cursor-pointer text-left transition-all duration-200 ${
